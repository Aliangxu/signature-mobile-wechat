...
import SignaturePadBase, { Options } from './signature-base';

export default class SignatureMobile extends SignaturePadBase {
  ...
  //   drawCurve: SignatureMobile['_drawCurve'],
  //   drawDot: SignatureMobile['_drawDot'],
  // ): void {
